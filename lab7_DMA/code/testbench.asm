...
ENTRY:		LHI	$0, 0
		...
		JMP	JMP0         ; 9076
JMP0:		WWD	$0	     ; f01c ; TEST #14-1 : JMP (= 0xFFFF)
		JMP	JMP1         ; 9079
		HLT              ; f01d
JMP1:		WWD	$1	     ; f41c ; TEST #14-2 : JMP (= 0x0001)

		BNE	$2, $3, BNE1 ; 0b01  << 7a
		JMP	BNE2         ; 907d  << 7b
BNE1:		HLT          ; f01d  << 7c
BNE2:	WWD	$0           ; f01c	 << 7d ; TEST #15-1 : BNE (= 0xFFFF)
		BNE	$1, $2, BNE3 ; 0601  << 7e
		HLT              ; f01d  << 7f
BNE3:	WWD	$1	         ; f41c  << 80; TEST #15-2 : BNE (= 0x0001)
		BEQ	$1, $2, BEQ1 ; 1601  << 81
		JMP	BEQ2         ; 9084  << 82
BEQ1:	HLT
BEQ2:	WWD	$0			 ; f01c  << 83 TEST #16-1 : BEQ (= 0xFFFF)
		BEQ	$2, $3, BEQ3 ; 1601  << 84
		HLT
BEQ3:	WWD	$1	      ; f41c ; TEST #16-2 : BEQ (= 0x0001)
		BGZ	$0, BGZ1  ; 
		JMP	BGZ2
BGZ1:		HLT
...
BLZ3:		WWD	$0	; TEST #18-2 : BLZ (= 0xFFFF)
		...
		JMP	BLZ5
BLZ4:		HLT
BLZ5:		WWD	$1  ; f41c	; TEST #18-3 : BLZ (= 0x0001)

		JAL	SIMPLE1 ; a0af
		WWD	$0	    ; f01c  ; TEST #19-1 : JAL & JPR (= 0xFFFF)

		JAL	SIMPLE2 ; a0ae
		HLT         ; f01d
		WWD	$1	    ; f41c; TEST #19-2 : JAL & JPR (= 0x0001)
